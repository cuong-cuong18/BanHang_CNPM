...
public class LapTopActivity extends AppCompatActivity {
    ...
    private GridView grv_laptop;
    private Adapter_SPTheoLoai adapter_laptop;
    private List<DTO_SPMoi> list_laptop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("LapTop ");
        id_laptop=getIntent().getIntExtra("idloaidsanpham",1);
        AnhXa();
        ActionBar();
    ...
    private void AnhXa(){
        grv_laptop=findViewById(R.id.grv_laptop);
        ...
        list_laptop=new ArrayList<>();
        //khởi tạo adapter

        adapter_laptop=new Adapter_SPTheoLoai(getApplicationContext(),list_laptop,list_thongtin);
        grv_laptop.setAdapter(adapter_laptop);
    }
                            ...
                            try {
                                ...
                                for (int i = 0; i < response.length(); i++){//dua vao vong lap
                                    try {
                                        ...
                                        list_laptop.add(new DTO_SPMoi(id_spmoi,ten_spmoi,hinh_spmoi,gia_spmoi,mota,id_loaisp_fk));//dua vao mang
...
//                            Toast.makeText(getApplicationContext(),ten_spmoi,Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("id_loaisp",String.valueOf(id_laptop));
                return param;
            }
